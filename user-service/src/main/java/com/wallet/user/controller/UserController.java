    ...
    public class UserController {
        ...
        public ResponseEntity<ResponseDTO<UserResponseDTO>> createUser(@RequestBody @Valid UserRequestDTO userRequestDTO) throws RoleNotFoundException {
        ...
        @GetMapping("/me")
        public ResponseEntity<ResponseDTO<UserResponseDTO>> getMyProfile() throws Exception {
        ...
        @DeleteMapping("/me")
        public ResponseEntity<ResponseDTO<Void>> deleteMyAccount() throws Exception {
            Long currentUserId = userService.getAuthenticatedUserId();
